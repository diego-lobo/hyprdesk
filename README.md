...
it:
    ...
    ~/.config/omarchy/plugins/hyprdesk.desks  -> config/omarchy/plugins/hyprdesk.desks
...
- `config/omarchy/plugins/hyprdesk.desks/` - Quickshell bar widget drawing the
  desk strip. Enabled with `omarchy plugin enable hyprdesk.desks`, which also
